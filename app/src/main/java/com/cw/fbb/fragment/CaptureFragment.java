...
import com.cw.fbb.R;
import com.cw.fbb.bean.LargestFingerData;
import com.cw.fbb.interfaces.FileSelectCallBack;
import com.cw.fbb.utils.DBHelper;
import com.cw.fbb.utils.MediaPlayerHelper;
import com.cw.fbb.widget.FingerView;
import com.cw.fbb.widget.OpenCaptureFileDialog;
...
public class CaptureFragment extends BaseFragment implements View.OnClickListener {
    ...
    private String rootPath = MyApplication.COMMON_PATH + "/FingerData/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (root == null) {
            ...
            mCheckBox_auto_save.setChecked((Boolean) getParameterFromPreferences(MyApplication.AUTO_SAVE, false));
            mTextView_lable_file_path.setSelected(true);
            mTextView_lable_file_path.setText((String) getParameterFromPreferences(MyApplication.FEATURE_PATH, null));
            mTextView_select_feature_format.setText((String) getParameterFromPreferences(MyApplication.FEATURE_FORMAT, null));
            mTextView_select_image_format.setText((String) getParameterFromPreferences(MyApplication.IMAGE_FORMAT, null));
            mEditText_image_quality_threshold.setText((String) getParameterFromPreferences(MyApplication.CAPTURE_IMAGE_QUALITY_THRESHOLD, null));
            rootPath = (String) getParameterFromPreferences(MyApplication.FEATURE_PATH, null);
            ...
            mCheckBox_auto_save.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    saveParameterToPreferences(MyApplication.AUTO_SAVE, isChecked);
                    if (isChecked) {
            ...
            mEditText_image_quality_threshold.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    saveParameterToPreferences(MyApplication.CAPTURE_IMAGE_QUALITY_THRESHOLD, s.toString());
                }
            });
        }
    ...
    private void exportFilePath() {
        OpenCaptureFileDialog openCaptureFileDialog = new OpenCaptureFileDialog(getContext(), new FileSelectCallBack() {
            ...
            public void backFilePath(String path) {
                ...
                saveParameterToPreferences(MyApplication.FEATURE_PATH, rootPath);
            }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (type == TYPE_FEATURE) {
                    ...
                    saveParameterToPreferences(MyApplication.FEATURE_FORMAT, mFeatureFormat);
                    popupWindow.dismiss();
                    ...
                    saveParameterToPreferences(MyApplication.IMAGE_FORMAT, mImageFormat);
    ...
    private boolean checkSettings() {
        ...
        if ("".equals(imageQuality) || Integer.parseInt(imageQuality) < 50 || Integer.parseInt(imageQuality) > 100) {
    ...
    public void onClick(View view) {
        ...
        boolean isAutoSave = (boolean) getParameterFromPreferences(MyApplication.AUTO_SAVE, false);
        if (isAutoSave && !checkSettings()) {
            return;
        }
    ...
    private class CaptureTask extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            do {
                ...
                if (isAutoSave && largestFingerData.isIsrRaise()) {
                ...
                try {
                            ...
                            switch (mImageFormat) {
                                ...
                                case "iso-fir":
                                    fpImage_Data = mTrustFingerDevice.rawToISO(fpImage_Raw
                                            ...
                                            , mTrustFingerDevice.getImageInfo().getResolution()
                                            , mFingerPosition
                                            , ImgCompressAlg.COMPRESSED_JPEG2000);
                                    break;
                                case "ansi-fir":
                    ...
                    if (!isFakeFinger && (imageQuality < 20 || imageQuality == 0) && !largestFingerData.isIsrRaise() && largestFingerData.getImgQuality() >= mImageQualityThrethold) {
                        saveFingerData(largestFingerData.getFpImageData(), largestFingerData.getFpFeatureData(), largestFingerData.getImgQuality());
    ...
    private void saveFingerData(byte[] fpImageData, byte[] fpFeatureData, final int imgQuality) {
        ...
        mCaptureTask = null;
        isCaturing = false;
        mHandler.sendMessage(mHandler.obtainMessage(MSG_CAPTURE_SUCCESS, imgQuality, 0, mFingerPosition.name()));
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_CAPTURE_SUCCESS: {
                    ...
                    SpannableStringBuilder builder = new SpannableStringBuilder(beforePosition + fingerPosition + afterPosition + sQuality);
