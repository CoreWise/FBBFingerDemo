...
import com.cw.fbb.R;
import com.cw.fbb.adapter.MyListAdapter;
...
import com.cw.fbb.widget.OpenFileDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (root == null) {
            ...
            mEditText_image_quality_threshold.setText((String) getParameterFromPreferences
                    (MyApplication.ENROLL_IMAGE_QUALITY_THRESHOLD, null));
            ...
            mEditText_image_quality_threshold.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    saveParameterToPreferences(MyApplication.ENROLL_IMAGE_QUALITY_THRESHOLD, s
                            .toString());
                }
            });
            ...
            mButton_import_user.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String feature_path = (String) getParameterFromPreferences(MyApplication
                            .FEATURE_PATH, null);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            do {
                ...
                if (mTrustFingerDevice == null) {
                    ...
                    // (MSG_ENROLL_WARNING, "Device not opened"));
                    handleMsg("Device not opened", Color.RED);
                    break;
                }
