...
import com.cw.fbb.R;
import com.cw.fbb.adapter.MyRankListAdapter;
import com.cw.fbb.bean.FingerData;
import com.cw.fbb.bean.LargestFingerData;
import com.cw.fbb.bean.User;
import com.cw.fbb.utils.DBHelper;
import com.cw.fbb.utils.MediaPlayerHelper;
import com.cw.fbb.widget.MyListView;
...
public class IdentifyFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (root == null) {
            ...
            mEditText_image_quality_threshold.setText((String) getParameterFromPreferences(MyApplication.IDENTIFY_IMAGE_QUALITY_THRESHOLD, null));
            String level =  (String) getParameterFromPreferences(MyApplication.IDENTIFY_SECURITY_LEVEL, null);
            ...
            mEditText_image_quality_threshold.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    saveParameterToPreferences(MyApplication.IDENTIFY_IMAGE_QUALITY_THRESHOLD, s.toString());
                }
            });
    ...
    private void showPopupWindow() {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mTextView_select_security_level.setText(level);
                saveParameterToPreferences(MyApplication.IDENTIFY_SECURITY_LEVEL, level);
                popupWindow.dismiss();
                switch (level) {
                    case "Level1":
                        mSecurityLevel = SecurityLevel.Level1;
